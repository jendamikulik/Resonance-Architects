...
if __name__ == "__main__":
    ...
    run_core_frame_window(N=10**1000, W= 10_000, n_zeros=5, gamma_source="zetazero", score_top_k=10_001)
...
def _maybe_run_spectral_fill_from_argv(argv):
    ...
    seed = _get_arg("--seed", 0, int)
    show_plot = ("--no_plot" not in argv)

    run_spectral_fill(n=n, sigma=sigma, eps_floor=eps_floor, steps=steps, seed=seed, show_plot=show_plot)
    return True
